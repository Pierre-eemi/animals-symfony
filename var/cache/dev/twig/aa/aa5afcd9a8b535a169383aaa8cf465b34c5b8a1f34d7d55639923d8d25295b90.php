...
class __TwigTemplate_d29a3f83b1db997519de082efcb258ecd1e2929143216553832c073ed05fcfae extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 7
        echo "        <h3>Liste des animaux possédés : </h3>
        ";
        // line 8
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["personne"]) || array_key_exists("personne", $context) ? $context["personne"] : (function () { throw new RuntimeError('Variable "personne" does not exist.', 8, $this->source); })()), "disposes", [], "any", false, false, false, 8));
        foreach ($context['_seq'] as $context["_key"] => $context["dispose"]) {
            ...
            echo "            <div class=\"row align-items-center\">
                <div class=\"col-2\">
                    <img src=\"";
            // line 11
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("images/" . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["dispose"], "animal", [], "any", false, false, false, 11), "image", [], "any", false, false, false, 11))), "html", null, true);
            echo "\" >
                </div>
                <div class=\"col\">
                    <h2><a href=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("afficher_animal", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["dispose"], "animal", [], "any", false, false, false, 14), "id", [], "any", false, false, false, 14)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["dispose"], "animal", [], "any", false, false, false, 14), "nom", [], "any", false, false, false, 14), "html", null, true);
            echo "</a></h2>
                    <div>Nombre : ";
            // line 15
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["dispose"], "nb", [], "any", false, false, false, 15), "html", null, true);
            echo "</div>
                </div>
            </div>
        ";
...
";
    ...
    {
        return array (  141 => 19,  131 => 15,  125 => 14,  119 => 11,  115 => 9,  111 => 8,  108 => 7,  98 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "personne/afficherPersonne.html.twig", "/Users/macbook/Desktop/Realisations/2-animaux/templates/personne/afficherPersonne.html.twig");
    }
}
